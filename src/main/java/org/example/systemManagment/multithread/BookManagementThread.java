...
public class BookManagementThread implements Runnable {
    private Queue<Object> requestQueue = new LinkedList<>();
    private final LibraryService libraryService;
    private final LibraryRepository libraryRepository;
    private Lock lock = new ReentrantLock();

    public BookManagementThread(Queue<Object> requestQueue, LibraryService libraryService, LibraryRepository libraryRepository) {
